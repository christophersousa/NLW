  ...
  return(
    <div className="flex flex-col gap-4">
      <div className="flex gap-3">
        ...
        <div className="w-72 px-3 py-1.5 bg-transparent border border-white/10 rounded-lg text-sm flex items-center gap-3">
              ...
              <tr key={index} className="border-b border-white/10">
                ...
                <td className="py-3 px-4 text-sm text-zinc-300">
                  <div className="flex flex-col gap-1">
                    <span className="font-semibold text-white">Christopher Silva de Sousa</span>
                    <span>christopher@teste.com.br</span>
                  </div>
                </td>
